...
namespace H2M_Profile_Switcher
{
    public partial class Form1 : Form
    {
        ...
        private void refreshlist()
        {
            ...
            if (!new DirectoryInfo(exeDirectory + "\\H2M Profiles").Exists)
            {
                Directory.CreateDirectory("H2M Profiles");
            }
            string[] directories = Directory.GetDirectories(exeDirectory + "\\H2M Profiles");
        ...
        private void Set_Profile_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    CopyDirectory(AppDomain.CurrentDomain.BaseDirectory + "\\H2M Profiles" + "\\" + Profile_List.SelectedItems[0].ToString(), Properties.Settings.Default.H2MPath + "\\players2\\user");
        ...
        private void Update_Profile_from_H2M_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    CopyDirectory(Properties.Settings.Default.H2MPath + "\\players2\\user", AppDomain.CurrentDomain.BaseDirectory + "\\H2M Profiles" + "\\" + Profile_List.SelectedItems[0].ToString());
        ...
        private void Delete_Profile_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    Directory.Delete("\\H2M Profiles" + Profile_List.SelectedItems[0].ToString(), true);
        ...
        private void Launch_Game_Click(object sender, EventArgs e)
        {
            ...
            // If i dont do this H2M Will have weird issues :(
